  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Brand palette — pastel blue & yellow (Instituto Primeiro Olhar).
        brand: {
      ...
      // Shared, ordered categorical palette for charts (pastel, accessible).
      // Consumed by chart components via CSS var or the CHART_COLORS constant.
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
